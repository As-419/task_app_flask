...
├── react/           # React/Next.js — Bulletproof React architecture
│   ├── project-structure.md   # Feature-based structure + unidirectional imports
│   ├── coding-style.md        # Component rules, composition, TypeScript
│   ├── state-management.md    # 4 state types + decision tree
│   ├── api-layer.md           # Axios instance, react-query, MSW
│   ├── testing.md             # Vitest, Testing Library, Playwright
│   ├── security.md            # Auth, RBAC, XSS, env vars
│   └── hooks.md               # PostToolUse hooks for React projects
